    ...
    if ($formAction === 'save') {
        ...
        try {
            ...
            if ($docId > 0) {
                ...
                setFlash('success', 'Document entry logged successfully.');
            }
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 pb-2 border-bottom">
        <div>
            <h3 class="fw-bold mb-1" style="color: var(--primary-color);">
                <i class="bi bi-box-arrow-in-down me-2 text-primary"></i> Document Log
            </h3>
            <p class="text-muted mb-0 small">Repository for all files, letters, and documents received by the office.</p>
        </div>
        ...
        <div class="mt-3 mt-md-0">
            <button type="button" class="btn btn-primary-custom shadow-sm" data-bs-toggle="modal" data-bs-target="#addDocumentModal">
                <i class="bi bi-plus-lg me-1"></i> Add Log Entry
            </button>
        </div>
        <?php endif; ?>
    </div>
        ...
        <div class="card card-custom">
            <div class="card-header card-header-custom d-flex justify-content-between align-items-center">
                <h5 class="card-title fw-bold mb-0 text-dark">
                    <i class="bi bi-list-ul me-2 text-primary"></i> Log Entries
                </h5>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="<?= hasRole('admin') ? '10' : '9' ?>" class="text-center py-5 text-muted">
                                    ...
                                    No document logs matched your criteria.
                                </td>
                            </tr>
                            <?php else: ?>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <form method="POST" action="document_log.php" enctype="multipart/form-data" class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-footer bg-light">
                ...
                <button type="submit" class="btn btn-primary-custom px-4"><i class="bi bi-save me-1"></i> Save Entry</button>
            </div>
        </form>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    editBtns.forEach(btn => {
        btn.addEventListener('click', function () {
            ...
            document.getElementById('modalTitle').innerHTML = '<i class="bi bi-pencil me-2"></i> Edit Entry';
